...
def train():
    ...
    num_envs = 2048  # Mantido em 2048 conforme solicitado
    episode_length = 1000  # Tamanho do episódio (passos de simulação por episódio)
    learning_rate = 3e-4
    unroll_length = 32
    batch_size = 2048
    num_minibatches = 8   # Otimizado de 32 para 8 (reduz overhead de backprop na GPU em 4x)
    num_updates_per_batch = 4  # Otimizado de 8 para 4 (reduz overhead de gradientes na GPU em 2x)
